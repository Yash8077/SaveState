...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C80oSy4K.mjs");
...
var manifest = {
	"120083326ba73d4cade6c2e12dfbbfe8c3f6fe395ac17db5b2f307afcdb041d1": {
		functionName: "removeEntry_createServerFn_handler",
		importer: () => import("./api-CBpzgHxD.mjs")
	},
	"1bf37280c0c6b80b9ba6963d2a55e75dbde04d0dfd9ece0166e3183f979c25f4": {
		functionName: "listLibrary_createServerFn_handler",
		importer: () => import("./api-CBpzgHxD.mjs")
	},
	"8553d862aadfc738536e5d1827229fe51ae785ed85da2cfe154ae61449c5c014": {
		functionName: "addToLibrary_createServerFn_handler",
		importer: () => import("./api-CBpzgHxD.mjs")
	},
	"945a48daea4d7604d324408eb041748924bbc1bbc39724fdef0bc4ec6c28b9e7": {
		functionName: "updateEntry_createServerFn_handler",
		importer: () => import("./api-CBpzgHxD.mjs")
	},
	"c0f29acad5b84303be36bd9c19e197d83a10b99bfce57b0a107beb605871c83a": {
		functionName: "addCustomGame_createServerFn_handler",
		importer: () => import("./api-CBpzgHxD.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BQDdMn6j.mjs").then((n) => n.t),

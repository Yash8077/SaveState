...
const _destinations = [
  PillDestination(icon: Icons.home_outlined, selectedIcon: Icons.home_rounded, label: 'Home'),
  PillDestination(icon: Icons.explore_outlined, selectedIcon: Icons.explore_rounded, label: 'Discover'),
  PillDestination(icon: Icons.library_books_outlined, selectedIcon: Icons.library_books_rounded, label: 'Library'),
  PillDestination(icon: Icons.bar_chart_outlined, selectedIcon: Icons.bar_chart_rounded, label: 'Stats'),
  PillDestination(icon: Icons.emoji_events_outlined, selectedIcon: Icons.emoji_events_rounded, label: 'Trophies'),
];
...
class AppShell extends StatelessWidget {
  ...
  void _onItemTapped(int index, BuildContext context) {
    switch (index) {
      ...
      case 4: context.go('/trophies'); break;
    }
  }
        ...
        body: Stack(
          children: [
            ...
            Positioned(
              ...
              child: wide ? Center(child: pill) : Align(alignment: Alignment.bottomCenter, child: pill),
            ),
          ],
        ),
      ),
